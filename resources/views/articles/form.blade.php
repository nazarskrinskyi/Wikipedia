<x-app-layout>
    <div class="max-w-3xl mx-auto p-6 bg-white dark:bg-gray-800 shadow-md rounded-lg mt-10">
        <form action="{{ isset($article) ? route('articles.update', $article) : route('articles.store') }}" method="POST">
            ...
            <!-- Content -->
            <div class="mb-6">
                <label for="editor" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Content</label>
            ...
            <!-- Description -->
            <div class="mb-6">
                <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Short Description</label>
